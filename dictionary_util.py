...
white = ['22 A Baco', 'AG Cleret', 'AG Kleret', 'AZ 7957', 'Abbondosa', 'Abboudossa', 'Abbsudosa', 'Abelione',
         ...
         'Žilavka Bijela', 'Žlahtina', 'White Blend', 'Sauvignon Blanc', 'Champagne Blend', 'Portuguese White',
         'Bordeaux-style White Blend', 'Pinot Grigio']

for wine in white:
    wine_dict[wine] = 'white'
...
rose = ['Agdam Gyzyl Uzumu', 'Agdam gyzyl izyum', 'Agdam gyzyl uzumu', 'Agdam qizil uezuemue', "Agdam's gyzyl uzumu",
        ...
        'Pink Chablis', 'Rielsing Rose', 'Rosé']

wine_dict['Sparkling Blend'] = 'unknown'

for wine in rose:
    wine_dict[wine] = 'rose'

with open('wine_dict.json','w') as fp:
    json.dump(wine_dict, fp, sort_keys=True, indent=4)

with open('country_dict.json', 'w') as fp:
    json.dump(country_dict, fp, sort_keys=True, indent=4)